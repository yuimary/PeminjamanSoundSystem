// Cloud Function: extractSurat
//
// Versi Firebase dari Netlify Function "extract-surat". Menerima PDF surat
// (base64) dari browser, mengirimkannya ke Google Gemini API untuk dibaca,
// lalu mengembalikan data terstruktur (tanggal, waktu, acara, dst) sebagai
// JSON. API key disimpan sebagai secret di Firebase (GEMINI_API_KEY),
// sehingga tidak pernah terlihat oleh browser/pengguna.
//
...
//
// Cara set secret-nya (dijalankan sekali dari terminal):
//   firebase functions:secrets:set GEMINI_API_KEY
//
// Endpoint otomatis tersedia di: /api/extract-surat (lewat rewrite di firebase.json)
...
exports.extractSurat = onRequest(
  { secrets: [GEMINI_API_KEY], region: 'asia-southeast2', cors: true },
  async (req, res) => {
    if (req.method !== 'POST') {
